...
def predict_vm(ecs_lines, input_lines):
    ...
    #bag problem
      #cal the bound
    bound=calBound(preResult,VmList,Ccpu,Cmem)
      #cpuW,memW,Ccpu,Cmem,V,dataName
    bagResult=[]
    thing=[]
    init_thing(thing,V)
      #V:to cal the len; bound:to set the bound;20:to set the first num
    yichuan(len(V),bound,5,Ccpu,Cmem,cpuW,memW,10000,0.3,0.1)
#    sumPack=0
